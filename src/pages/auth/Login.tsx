        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch min-h-[600px]">
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-6">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl hover:shadow-3xl transition-shadow duration-300">
          ...
          <div className="flex flex-col justify-center">
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-12 space-y-8 border border-white/20">
              <div>
                ...
                <p className="text-gray-600 font-medium">Enter your PIN to access your account</p>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className="bg-blue-50 px-3 py-2 rounded-lg text-center border border-blue-200">
                    ...
                    <p className="text-blue-700 font-mono">9999</p>
                  </div>
                  <div className="bg-teal-50 px-3 py-2 rounded-lg text-center border border-teal-200">
                    <p className="font-bold text-teal-900">Manager</p>
                    <p className="text-teal-700 font-mono">8888</p>
                  </div>
                  <div className="bg-green-50 px-3 py-2 rounded-lg text-center border border-green-200">
                    <p className="font-bold text-green-900">Cashier</p>
                    <p className="text-green-700 font-mono">1234</p>
                  </div>
                </div>
              </div>
            </div>
